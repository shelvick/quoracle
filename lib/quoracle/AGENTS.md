...
- costs/: Agent cost tracking - AgentCost schema, Recorder, Aggregator v5.0 with DRY SQL + per-model detailed queries + batch_totals UNION ALL query (added 2025-12-13)
