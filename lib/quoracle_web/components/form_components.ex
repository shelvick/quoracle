defmodule QuoracleWeb.FormComponents do
  @moduledoc """
  Form-related UI components for the application.

  This module contains components for building forms, including
  inputs, buttons, labels, and error messages.
  """
  ...
  attr(:field, FormField,
    doc: "a form field struct retrieved from the form, used to generate input names and errors"
  )
